...
export default function Partner({
    ...
    intro =
    "At Ultimate Integrated Support Services Inc, we know that the success of your facility depends on the quality of the people behind it. That's why we go beyond filling positions—we build lasting partnerships grounded in trust, reliability, and excellence. When you work with us, you gain:",
    reasons = [
        {
